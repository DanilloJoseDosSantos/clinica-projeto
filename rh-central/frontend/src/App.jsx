      ...
      <main className="content-grid">
        <section className="panel">
          ...
          {user.role === 'rh' ? <form className="form-grid" onSubmit={handleCollaboratorSubmit}>
            ...
            <button className="primary-button" type="submit">Salvar colaborador</button>
        ...
        <section className="panel">
          ...
          <form className="form-grid" onSubmit={handleIntakeSubmit}>
            ...
            <button className="primary-button contrast" type="submit">Gerar protocolo</button>
          </form>
              ...
              <article key={ticket.id} className="ticket-card">
                ...
                <div className="attachments-box">
                  ...
                  <div className="attachments-upload-row">
                    ...
                    <button type="button" className="ghost-button" onClick={() => handleTicketAttachmentUpload(ticket.id)}>Enviar anexo</button>
                  </div>
                ...
                <div className="ticket-footer">
                  ...
                  <div className="ticket-actions-column">
                    ...
                    <button type="button" className="ghost-button" onClick={() => handleAssignTicket(ticket.id)}>Salvar responsável</button>
          ...
          <div className="tickets-header phase-block-title">
            ...
            {user.role === 'rh' ? <button type="button" className="ghost-button" onClick={handleSlaSweep}>Executar sweep de SLA</button> : null}
          </div>
          ...
          <form className="form-grid" onSubmit={handleWebhookSubmit}>
            ...
            <button className="primary-button" type="submit">Processar webhook automático</button>
          </form>
